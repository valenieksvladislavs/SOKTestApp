<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#fff" class="bi bi-emoji-sunglasses-fill" viewBox="0 0 16 16">
    ...
    <div class="collapse navbar-collapse overflow-auto" id="mainNavbar">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 flex-nowrap">
        <?php foreach ($topLevelSections as $section): ?>
          <li class="nav-item">
            <a 
              class="nav-link text-white text-nowrap" 
              href="/view/<?=$section['slug']?>"
            >
